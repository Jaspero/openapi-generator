package com.jaspero.nodejs-express-typescript-server;
 ...
 * 1) Set a break point in NodejsExpressTypescriptServerGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class NodejsExpressTypescriptServerGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("nodejs-express-typescript-server") // use this codegen library
              ...
              .setOutputDir("out/nodejs-express-typescript-server"); // output directory
