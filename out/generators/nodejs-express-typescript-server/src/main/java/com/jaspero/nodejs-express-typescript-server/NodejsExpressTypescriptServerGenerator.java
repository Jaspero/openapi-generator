...
public class NodejsExpressTypescriptServerGenerator extends DefaultCodegen implements CodegenConfig {

    private final Logger LOGGER = LoggerFactory.getLogger(NodejsExpressTypescriptServerGenerator.class);
    ...
    public NodejsExpressTypescriptServerGenerator() {
        super();
        ...
        outputFolder = "generated-code/nodejs-express-typescript-server";
        embeddedTemplateDir = templateDir = "nodejs-express-typescript-server";
    ...
    public String getHelp() {
        return "Generates a NodeJS Express Typescript server (alpha). IMPORTANT: this generator may subject to breaking changes without further notice).";
    }
